...
$allInfo = $info->getInfoDateAsc($o_conn);
...
<form action="" method="post">
            <div class="col">
                <select class="form-control" name="start">
                    <option>Filtre par notes</option>
                ...
                <input type="submit" class="btn-primary" name="search" value="valider">
                <br />
                <br />
        ...
        <div class="col">
            <select class="form-control" name="start" onchange="location = this.value;">
                <option>tri par dates</option>
                <option value="tri.php"> Date - Descendant</option>
                <option value="tri1.php">Date - ascendant</option>
            </select>
        </div>
